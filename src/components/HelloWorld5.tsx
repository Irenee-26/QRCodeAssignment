...
const HelloWorld5: React.FC<Props> = (props) => {
    ...
    */
    ...
    //from document .... is the argument USEEFFECT is receiving 
    ...
    //everything inside return will determine what will be displayed
...
//what you are passing to onClick is a function 
